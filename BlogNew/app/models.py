...
class User(db.Model):
    ...
    # 增加与Topic之间的关联关系和反向引用关系
    topics = db.relationship("Topic", backref="user",lazy="dynamic")

    # 增加与Reply之间的关联关系和反向引用关系
    replies = db.relationship("Reply", backref='user', lazy="dynamic")

    # 增加多User对多Topic的关联属性和反向引用关系
    voke_topics=db.relationship('Topic',secondary='voke',lazy='dynamic',
...
class Topic(db.Model):
    ...
    read_num = db.Column(db.Integer,default=False)
